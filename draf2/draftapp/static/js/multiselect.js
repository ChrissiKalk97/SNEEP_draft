function MultiSelectTag(
    ...
    function h(e=null){
        ...
        function f(e){
            ...
            (t=>{d.find((t=>t.value==e.value)).selected=!1,g(e.value),h(),E()})),t.appendChild(n),t.appendChild(l),o.append(t)}function L(){
                for(var e of v.children)e.addEventListener("click",(e=>{
                    ...
                    function w(e){
                        ...
                        function g(e){for(var t of o.children)t.classList.contains("input-body")||t.firstChild.dataset.value!=e||o.removeChild(t)}
                        function E(){for(var e=0;e<d.length;e++)n.options[e].selected=d[e].selected}n=document.getElementById(e),
                        function(){d=[...n.options].map((e=>({value:e.value,label:e.label,selected:e.selected}))),
                        ...
                        v=document.createElement("ul"),p.appendChild(v),
                        l.appendChild(a),
                        l.appendChild(p),
                        n.nextSibling?n.parentNode.insertBefore(l,n.nextSibling):n.parentNode.appendChild(l)}(),h(),L(),E(),
