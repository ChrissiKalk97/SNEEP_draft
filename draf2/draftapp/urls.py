...
urlpatterns = [
    ...
    path('Snp_detail/<pk>/', views.SnpsDetailView.as_view(), name = 'snp_detail'),
    path('Snp_search/Snp_results/', views.snp_search_results, name = 'snp_search_results'),
    ...
    path('REST_API/GeneQuery/<genes>/', views.GeneQueryRESTAPIview)
 ]
